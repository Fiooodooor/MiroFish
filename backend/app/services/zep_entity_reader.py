...
class ZepEntityReader:
    ...
    def filter_defined_entities(
        ...
        Args:
            graph_id: Graph ID
            defined_entity_types: Predefined entity type list (optional; if provided, only retain these types)
        ...
        # Fetch all edges (for subsequent association lookup)
        all_edges = self.get_all_edges(graph_id) if enrich_with_edges else []
        
        # Build a mapping from node UUID to node data
        node_map = {n["uuid"]: n for n in all_nodes}
        
        # Filter entities meeting the criteria
        filtered_entities = []
