...
class OasisProfileGenerator:
    ...
    Converts entities from the Zep knowledge graph into Agent Profiles for OASIS simulation
    ...
    def _search_zep_for_entity(self, entity: EntityNode) -> Dict[str, Any]:
        ...
        Zep has no built-in hybrid search interface; edges and nodes are searched separately and results are merged.
        Parallel requests are used for simultaneous search to improve efficiency.
    ...
    def _is_individual_entity(self, entity_type: str) -> bool:
        """Determine whether the entity is an individual person type"""
    ...
    def _generate_profile_with_llm(
        ...
        - Individual entity: generate a specific character setting
        - Group/institution entity: generate a representative account setting
        """
    ...
    def _get_system_prompt(self, is_individual: bool) -> str:
        """Get system prompt"""
        base_prompt = "You are an expert in generating social media user personas. Generate detailed, realistic personas for public opinion simulation, restoring real-world situations to the greatest extent possible. Must return valid JSON format; all string values must not contain unescaped newlines. Use Chinese for persona content."
        return base_prompt
    ...
    def _build_individual_persona_prompt(
        ...
        return f"""Generate a detailed social media user persona for this entity, restoring real-world situations to the greatest extent possible.
...
- Use Chinese for content (except the gender field which must use English male/female)
...
"""
    ...
    def _build_group_persona_prompt(
        ...
        return f"""Generate a detailed social media account setting for this institution/group entity, restoring real-world situations to the greatest extent possible.
...
2. persona: Detailed account setting description (2000 characters of plain text), including:
   - Institution basic information (formal name, nature, founding background, main functions)
   ...
   - Content publishing traits (content types, posting frequency, active time periods)
...
- Use Chinese for content (except the gender field which must use English "other")
...
- Institutional account speech must match its identity and positioning"""
    ...
    def _print_generated_profile(self, entity_name: str, entity_type: str, profile: OasisAgentProfile):
        ...
        output_lines = [
            ...
            f"Occupation: {profile.profession} | Country: {profile.country}",
    ...
    def _normalize_gender(self, gender: Optional[str]) -> str:
        ...
        # Chinese mapping
        gender_map = {
            "\u7537": "male",    # Chinese word for "male"
            "\u5973": "female",  # Chinese word for "female"
            "\u673a\u6784": "other",  # Chinese word for "institution"
            "\u5176\u4ed6": "other",  # Chinese word for "other"
            # English values already handled
            "male": "male",
            "female": "female",
            "other": "other",
        }
